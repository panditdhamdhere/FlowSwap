...
const ThemeToggle: React.FC = () => {
  ...
  return (
          <motion.button 
      onClick={toggleTheme}
      className="p-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
      title={`Current theme: ${getLabel()}. Click to cycle through Light → Dark → System`}
          >
      {getIcon()}
...
// (Removed modal-based WalletSelector in favor of dropdown attached to Connect button)
    ...
    <div className="relative">
      ...
      {showWalletSelector && (
        ...
        >
          <div className="py-1">
            {[
              { id: 'blocto', name: 'Blocto', icon: '🔵', desc: 'Popular Flow wallet' },
              { id: 'lilico', name: 'Lilico', icon: '🟣', desc: 'Lightweight wallet' },
              { id: 'dapper', name: 'Dapper', icon: '🟢', desc: 'Enterprise-grade wallet' },
            ].map((w) => (
              <button
                key={w.id}
              ...
              >
                ...
                <div>
                  <div className="text-sm font-semibold text-gray-800 dark:text-gray-200">{w.name}</div>
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 p-2">
            <button
              ...
              className="w-full text-xs px-3 py-2 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-600"
            >
              Cancel
            </button>
          </div>
