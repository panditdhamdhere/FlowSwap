        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="text-left">
            ...
            <div className="text-xs text-gray-500 dark:text-gray-400">
              {selectedPair ? `$${getPairPrice(selectedPair.id).toFixed(4)}` : 'Choose trading pair'}
            </div>
          </div>
        </div>
        <div className="flex items-center space-x-1">
          {selectedPair && (
            <div className="text-right">
              <div className={`text-xs font-medium ${getPriceChangeColor(selectedPair.priceChange24h)}`}>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="absolute top-full left-0 right-0 mt-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl z-50 max-h-80 overflow-hidden"
          >
            {/* Tabs */}
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        <div className="flex items-center space-x-1">
                          ...
                          <div className="w-5 h-5 bg-purple-500 rounded-full flex items-center justify-center text-white text-xs font-semibold -ml-1">
                      ...
                      <div className="text-right">
                        <div className="text-xs font-medium text-gray-800 dark:text-gray-200">
                          ${getPairPrice(pair.id).toFixed(4)}
                        </div>
                        <div className="flex items-center space-x-1">
